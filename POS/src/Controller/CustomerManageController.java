...
public class CustomerManageController {
    ...
    public static Connection getConnection() throws ClassNotFoundException, SQLException {
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/simplepos","root","");
        return con;
    ...
    public void initialize() throws Exception {
        ...
        unfriendCol.setCellFactory(param -> new TableCell<Customer, Customer>() {
            ...
            protected void updateItem(Customer customer, boolean empty) {
                ...
                deleteButton.setOnAction(
                        event -> {
                            try {
                                CustomerBO cusBo = BOFactory.getInstance().getDAO(BOTypes.CUSTOMER);
        ...
        for (CustomerDTO customer:businesscus.allCustomers()) {
